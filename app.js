...
if(day == 1 || day == 2 || day == 3) mapboxgl.accessToken = 'pk.eyJ1IjoiYmtjODUyMjAiLCJhIjoiY2wyN3R5dnl2MDE5YjNpazd2bmhzeGtqYyJ9.oWTYxlov_9_hx6d6g86YaQ';
if(day == 4 || day == 5 || day == 6) mapboxgl.accessToken = 'pk.eyJ1Ijoib2JiNzM4MDAiLCJhIjoiY2wyN3UxY2k4MDFibjNjbWV0bGUybHpoNSJ9.bxApr_RJ_BV9URR8AGPISA';
if(day == 7 || day == 8 || day == 9) mapboxgl.accessToken = 'pk.eyJ1IjoicnFnMTE4NjgiLCJhIjoiY2wyN3UyeHNuMDJ5ajN0bW0yYXZoZWM4bSJ9.EnQ8c_vLK7IbDeysSrljWA';
if(day == 10 || day == 11 || day == 12) mapboxgl.accessToken = 'pk.eyJ1IjoiZGN1NTg2NjYiLCJhIjoiY2wyN3U0NzdwMDMxbDNrbzY5N3gwNjFrMyJ9.sj0YPl49PiSmlIdkHBIg5A';
if(day == 13 || day == 14 || day == 15) mapboxgl.accessToken = 'pk.eyJ1IjoibWVtMTA2ODUiLCJhIjoiY2wyN3U1OXhxMDJ2ajNlbDNiZDlkbDI1YiJ9.AQcTfFX1bGwoOCdPnwA8Fg';
if(day == 16 || day == 17 || day == 18) mapboxgl.accessToken = 'pk.eyJ1Ijoia2FsMjI1NzgiLCJhIjoiY2wyN3U2YzhzMDE1ejNkcDNkYmdlYmg3MCJ9.esBb9f0A4WzVjF5kFLQmQg';
if(day == 19 || day == 20 || day == 21) mapboxgl.accessToken = 'pk.eyJ1IjoicWtpMzI5OTciLCJhIjoiY2wyN3U3bXNyMDB6ajNqbzh2dDYxcm9jYiJ9.f17NAk3hvbnQqI5pzREbbw';
if(day == 22 || day == 23 || day == 24) mapboxgl.accessToken = 'pk.eyJ1IjoieGVrNTY5NjEiLCJhIjoiY2wyN3U4eWl5MDFvbzNqcDJ2cDJnaWcxeiJ9.aSEWUDhazy2BbV3VcGr3Vw';
if(day == 25 || day == 26 || day == 27) mapboxgl.accessToken = 'pk.eyJ1IjoiZmx3NjUzMjUiLCJhIjoiY2wyN3VjMWhxMDMzZDNkbGd3NW5uN20zaSJ9.1h9f5u1kqgxpF2CEF8s2mg';
if(day == 28 || day == 29 || day == 30 || day == 31) mapboxgl.accessToken = 'pk.eyJ1IjoieHVvMjQyNjIiLCJhIjoiY2wyN3VkMnN4MDEwdDNkbzhldTRscmtmMyJ9.bI8Owlf0rxr9IAzW7uusNg';
